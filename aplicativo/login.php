...
if ($_POST) {
    ...
    $query = $db->prepare("SELECT * FROM usuario WHERE correo = :correo AND contraseña = :contrasena");
    ...
    if ($query->rowCount() > 0) {
        ...
        $_SESSION['id_usuario'] = $usuario['id_usuario']; // Actualiza con el nombre de la columna correcta
