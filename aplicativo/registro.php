...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    move_uploaded_file($imagen_temporal, $carpeta.$imagen_perfil);

    try {
        $sql = "INSERT INTO usuario (nombre, correo, contraseña, telefono, genero, fecha_nac, img_per) VALUES (:nombre, :correo, :contrasena, :telefono, :genero, :fecha_nacimiento, :imagen_perfil)";
