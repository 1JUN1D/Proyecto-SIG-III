...
if ($_POST) {
    ...
    $query = $db->prepare("SELECT * FROM prestador WHERE correo = :correo AND contraseña = :contrasena");
    ...
    if ($query->rowCount() > 0) {
        ...
        $_SESSION['id_empleado'] = $usuario['id_empleado']; // Actualiza con el nombre de la columna correcta
...
<body>
    <div class="card" style="width: 25rem; margin: 0 auto; top: 50%; position: absolute; transform: translateY(-50%);">
        <div class="card-body">
            ...
            <a href="registro.php" class="btn btn-success w-100">Regístrese</a>
        </div>
    </div>
</body>
