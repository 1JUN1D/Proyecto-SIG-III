...
<body>
    ...
    <div class="d-flex justify-content-center align-items-center" style="height: 100vh;">
        <div class="container mt-5 mb-5">
            ...
            <img src="img_usuarios/<?php echo $usuario['img_per']; ?>" class="rounded mx-auto d-block" alt="Foto de perfil" style="width: 200px; height: 200px; object-fit: cover;">
            ...
            <div class="card mt-3 mx-auto" style="max-width: 400px;">
                <div class="card-body">
                    ...
                    <p class="card-text"><strong>Correo:</strong> <?php echo $usuario['correo']; ?></p>
                    <p class="card-text"><strong>Teléfono:</strong> <?php echo $usuario['telefono']; ?></p>
                    <p class="card-text"><strong>Género:</strong> <?php echo $usuario['genero']; ?></p>
                    <p class="card-text"><strong>Fecha de Nacimiento:</strong> <?php echo $usuario['fecha_nac']; ?></p>
                    <p class="card-text"><strong>Fecha de Registro:</strong> <?php echo $usuario['fecha_reg']; ?></p>
                    <p class="card-text"><strong>Evaluación:</strong> <?php echo $usuario['evaluacion']; ?></p>
                </div>
            </div>

            <div class="d-grid gap-2 mt-3 mx-auto" style="max-width: 200px;">
